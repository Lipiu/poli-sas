...
## Recapitulare rapidă (checklist examen)

- [ ] Diferența `==` vs `.equals()` pentru wrapperi și obiecte
- [ ] Widening vs narrowing conversion
- [ ] `private` vs *package* vs `protected` vs `public`
- [ ] `extends` (moștenire) vs compunere (has-a)
- [ ] Overloading = compile-time, Overriding = runtime
- [ ] Abstract class (stare + constructor) vs Interface (contract, multiplă)
- [ ] Singleton – constructor privat + instanță statică
- [ ] Factory – ascunde crearea obiectelor concrete
- [ ] Observer – notificare automată la schimbare de stare
- [ ] Visitor – double dispatch, separă algoritm de structură
- [ ] List/Set/Map – când se folosește fiecare
- [ ] HashMap – necesită `equals()`+`hashCode()` corecte
- [ ] Checked vs Unchecked exceptions
- [ ] try-with-resources → `AutoCloseable`
- [ ] Byte streams vs Character streams
- [ ] Type erasure – generics nu există la runtime
- [ ] PECS – `extends` pentru citire, `super` pentru scriere

---

*Notițe pregătite pentru admiterea la master SAS / Securitate, UPB.*